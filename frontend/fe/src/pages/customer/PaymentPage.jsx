...
import { processDepositPayment, processFinalPayment } from "../../services/paymentService";
...
const PaymentPage = ({ type = "deposit" }) => {
    ...
    const paymentMethods = [
        { id: "bank_transfer", label: "Chuyển khoản QR", icon: Building2, description: "Quét mã QR để thanh toán nhanh" },
        { id: "cash", label: "Tiền mặt", icon: Wallet, description: "Thanh toán trực tiếp tại cửa hàng" },
        { id: "card", label: "Thẻ tín dụng", icon: CreditCard, description: "Visa, MasterCard, JCB" },
        { id: "momo", label: "Ví MoMo", icon: Wallet, description: "Thanh toán qua ứng dụng MoMo" },
        { id: "zalopay", label: "ZaloPay", icon: Wallet, description: "Thanh toán qua ứng dụng ZaloPay" },
        { id: "vnpay", label: "VNPay", icon: Building2, description: "Cổng thanh toán VNPay" },
    ];
    ...
    const getPaymentAmount = () => {
        ...
        return booking.total_amount - booking.deposit_amount;
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50 pt-32 pb-20">
            ...
            <div className="max-w-2xl mx-auto px-6">
                ...
                {/* Booking Summary */}
                <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 mb-6">
                    <h2 className="text-xl font-bold text-gray-900 mb-4">Thông tin đơn</h2>
                    ...
                    <div className="space-y-3">
                        {paymentMethods.map((method) => {
                            ...
                            return (
                                ...
                                >
                                    <div
                                        className={`w-12 h-12 rounded-full flex items-center justify-center ${selectedMethod === method.id ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-600"
                                            }`}
                                    >
                                        <Icon size={24} />
                                    </div>
                ...
                <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                    <p className="text-sm text-yellow-800">
                        <strong>Lưu ý:</strong> Sau khi thanh toán thành công, bạn sẽ nhận được email xác nhận và có thể
                        xem chi tiết giao dịch trong lịch sử thanh toán.
                    </p>
                </div>
            </div>
        </div>
