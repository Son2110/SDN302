...
const DepositPayment = () => {
    ...
    const loadBookingData = async () => {
        try {
            ...
            if (response.data.status !== "pending") {
                setError("Đơn hàng này đã được xử lý thanh toán cọc hoặc không hợp lệ.");
            }
        } catch (err) {
    ...
    const depositAmount = booking ? Math.round(booking.total_amount * 0.3) : 0;
    const remainingAmount = booking ? booking.total_amount - depositAmount : 0;
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-center gap-4">
                        <div className="flex items-center">
                            ...
                            <span className="ml-2 text-sm font-semibold text-gray-700">Chọn xe</span>
                        </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <span className="ml-2 text-sm font-semibold text-gray-700">Thông tin</span>
                        </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <span className="ml-2 text-sm font-semibold text-gray-700">Thanh toán</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-8">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">Chọn phương thức thanh toán online</p>
                                </div>
                            </div>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div className="text-sm text-yellow-800">
                                        ...
                                        <ul className="list-disc list-inside space-y-1">
                                            <li>
                                                Bạn cần thanh toán cọc <strong>30%</strong> để xác nhận đơn hàng
                                            </li>
                                            <li>
                                                Số tiền còn lại sẽ thanh toán khi nhận xe hoặc khi kết thúc chuyến đi
                                            </li>
                                            <li>Tiền cọc chỉ được thanh toán qua phương thức online</li>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                <div
                                                    className={`w-12 h-12 rounded-lg ${isSelected
                                                        ? `bg-${method.color}-100`
                                                        : "bg-gray-100"
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-32">
                            ...
                            <div className="space-y-3 border-b border-gray-200 pb-4 mb-4">
                                ...
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-semibold text-gray-900">
                                        ...
                                        -{" "}
                                        {booking && new Date(booking.end_date).toLocaleDateString("vi-VN")}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between text-base border-t border-gray-200 pt-3">
                                    <span className="font-bold text-gray-900">Tiền cọc (30%):</span>
                                ...
                                <div className="flex justify-between text-sm text-gray-600 pb-4 border-b border-gray-200">
                                    ...
                                    <span className="font-semibold">{formatPrice(remainingAmount)}đ</span>
                                </div>
                                ...
                                <div className="bg-green-50 border border-green-200 rounded-lg p-3 mt-4">
                                    <div className="flex gap-2">
                                        ...
                                        <div className="text-xs text-green-800">
                                            <p className="font-bold mb-1">Sau khi thanh toán thành công:</p>
                                            <ul className="list-disc list-inside space-y-1">
