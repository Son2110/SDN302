      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          <div className="text-center">
            <p className="text-sm text-gray-500 mb-1">Mã giao dịch (Txn ID)</p>
            <p className="font-mono text-xs bg-gray-100 inline-block px-3 py-1 rounded text-gray-700 font-semibold mb-3">{payment.transaction_id || "Không có"}</p>
          ...
          <div className="space-y-4 pt-4 border-t border-gray-100">
            ...
            <div className="bg-gray-50 p-4 rounded-xl mt-4">
              <p className="font-semibold text-gray-900 mb-2 border-b border-gray-200 pb-2">Thông tin liên quan</p>
